...
#define nstates1	11	/* never_0 */
#define minseq1	12
#define maxseq1	21
#define endstate1	10

#define nstates0	13	/* ticketlock */
#define minseq0	0
#define maxseq0	11
#define endstate0	12
...
#define Pticketlock	((P0 *)this)
typedef struct P0 { /* ticketlock */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, myticket) - 1*sizeof(int))
