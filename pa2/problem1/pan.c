...
{	int j, h = now._nr_pr;
	...
	case 0:	/* ticketlock */
		...
		/* params: */
		/* locals: */
		((P0 *)pptr(h))->myticket = 0;
#ifdef VAR_RANGES
		logval("ticketlock:myticket", ((P0 *)pptr(h))->myticket);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
{	/* int i; */
	...
	case 1:
		...
		break;
	case 0:
		printf("local vars proc %d (ticketlock):\n", pid);
	printf("	int    myticket:	%d\n", ((P0 *)pptr(pid))->myticket);
		break;
	}
}
void
